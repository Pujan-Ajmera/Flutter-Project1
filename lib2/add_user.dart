...
class AddUser extends StatefulWidget {
  ...
  int? editIndex; // Index of the item being edited (null for add mode)
...
class _AddUserState extends State<AddUser> {
  ...
  void initState() {
    ...
    if (widget.editIndex != null) {
      // Load the data of the user to be edited
      ...
      // Add hobbies selection logic if needed
    }
  }
  ...
  Widget _buildEmailField() {
    return TextFormField(
      ...
      keyboardType: TextInputType.emailAddress, // Proper keyboard for email
      validator: (value) {
          ...
          child: ElevatedButton(
            onPressed: () {
              if (_formKey.currentState?.validate() ?? false) {
                ...
                // Create the user data map in the required format
