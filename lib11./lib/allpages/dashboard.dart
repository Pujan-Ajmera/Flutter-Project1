...
class _DashboardState extends State<Dashboard> {
  ...
  List<Widget> pages = [AddUser(userDataList: AllList.userDataList,),Userlist(userDataList: AllList.userDataList,),Favourit(userDataList: AllList.userDataList,),EditButton(userDataList: AllList.userDataList,),AboutUsPage()];
  @override
