...
import 'package:matrimonyapi/allpages/charts.dart';
...
//AddUser(userDataList: AllList.userDataList,), 00  index ee inpages
  ...
  List<Widget> pages = [Userlist(userDataList: AllList.userDataList,),Favourit(userDataList: AllList.userDataList,),Charts(),AboutUsPage()];
  @override
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          // ),
          BottomNavigationBarItem(
            icon: Tooltip(message: "This are the charts",child: Icon(Icons.pie_chart)),
            label: "charts",
          ),
          BottomNavigationBarItem(
